...
var pvpHeader = (function(){
	...
	util.addHeaderHTML = function(){
		...
		headerHTML +='        </li>';
		headerHTML +='        <li>';
		headerHTML +='          <a href="//pvp.qq.com/match/kcc.shtml?ADTAG=pvp.hi" target="_blank" title="赛事中心" onclick="PTTSendClick(\'headNav\',\'match\',\'赛事中心\');">赛事中心<em>MATCH</em></a>';
		headerHTML +='        </li>';
		headerHTML +='        <li>';
		...
		headerHTML +='          </li>';
		headerHTML +='          <li class="down-nav">';
		headerHTML +='             <a href="/cp/a20170815version/index.htm?ADTAG=pvp.index.nav" target="_blank" title="版本介绍" onclick="PTTSendClick(\'headNav\',\'nav2_1\',\'版本介绍\');">版本介绍</a>';
		...
		headerHTML +='             <a href="/match/city.shtml" target="_blank" title="KOC王者城市赛" onclick="PTTSendClick(\'headNav\',\'match_KOC\',\'KOC\');">KOC王者城市赛</a>';
		...
		headerHTML +='             <a href="javascript:alert(\'敬请期待\')" target="_blank" title="王者高校联赛" onclick="PTTSendClick(\'headNav\',\'match_gaoxiao\',\'王者高校联赛\');">王者高校联赛</a>';
		headerHTML +='          </li>';
		headerHTML +='          <li class="down-nav">';
